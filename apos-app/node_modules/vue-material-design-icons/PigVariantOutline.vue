<template functional>
  <span :aria-hidden="props.decorative"
        ...
        class="material-design-icon pig-variant-outline-icon"
        role="img"
        v-bind="data.attrs"
        v-on="listeners">
...
<script>
export default {
  name: "PigVariantOutlineIcon",
  props: {
    title: {
      type: String,
      default: "Pig Variant Outline icon"
    },
    decorative: {
      type: Boolean,
      default: false
