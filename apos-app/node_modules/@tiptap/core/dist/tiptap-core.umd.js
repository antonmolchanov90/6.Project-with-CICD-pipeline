(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prosemirror-state'), require('prosemirror-transform'), require('prosemirror-commands'), require('prosemirror-model'), require('prosemirror-schema-list'), require('prosemirror-inputrules'), require('prosemirror-view'), require('prosemirror-keymap')) :
  typeof define === 'function' && define.amd ? define(['exports', 'prosemirror-state', 'prosemirror-transform', 'prosemirror-commands', 'prosemirror-model', 'prosemirror-schema-list', 'prosemirror-inputrules', 'prosemirror-view', 'prosemirror-keymap'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@tiptap/core"] = {}, global.prosemirrorState, global.prosemirrorTransform, global.prosemirrorCommands, global.prosemirrorModel, global.prosemirrorSchemaList, global.prosemirrorInputrules, global.prosemirrorView, global.prosemirrorKeymap));
})(this, (function (exports, prosemirrorState, prosemirrorTransform, prosemirrorCommands, prosemirrorModel, prosemirrorSchemaList, prosemirrorInputrules, prosemirrorView, prosemirrorKeymap) { 'use strict';
